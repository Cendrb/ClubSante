module ColorsHelper
  def get_calendar_color(object)
    case object
      when Exercise
        return (object.exercise_modification.coach && object.exercise_modification.coach.color_code) ? object.exercise_modification.coach.color_code : Coach.default_color
